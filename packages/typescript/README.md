...
This package provides an extensible ESLint configuration for TypeScript development in (not exclusively) the t3n.de domain.
...
```bash
npm install --save-dev @t3n/eslint-config @t3n/eslint-config-typescript
```
